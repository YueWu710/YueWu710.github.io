...
**This page presents a small selection of results from my ongoing projects.** To keep it concise, I include only high-level visual outcomes here. Full descriptions, pipelines, and broader work are detailed in my CV and statements.
...
Below is a diagram of the VAE architecture, along with the current results of applying it to identify driver genes for the undifferentiated-to-differentiated transition. The genes marked in red are known drivers from literature. The graph below shows the change in gene expression along this latent-space trajectory.
...
This visualization shows that as stress magnitude, duration, and time increase, cells transition progressively from hormesis (adaptive benefitial response) to senescence, and eventually to apoptosis.
